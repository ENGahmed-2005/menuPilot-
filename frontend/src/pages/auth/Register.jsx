...
import { ArrowLeft, ArrowRight, Check, Eye, EyeOff, LockKeyhole, Mail, Store } from "lucide-react";
            ...
            <div className="rounded-[28px] border border-[#4B5147]/10 bg-white p-5 shadow-[0_24px_70px_rgba(31,36,32,.08)] sm:p-8 md:p-10">
              ...
              {step === 4 && <StepFrame eyebrow="الخطوة الأخيرة" title="راجع بياناتك" description="تأكد من صحة المعلومات قبل إنشاء الحساب.">
                ...
                <div className="mt-6 flex gap-3">
                  ...
                  <button type="button" disabled={loading} onClick={submit} className="flex-[2] rounded-full bg-[#EEA122] px-5 py-3.5 text-sm font-black text-[#1F2420] transition hover:bg-[#E67E22] disabled:cursor-not-allowed disabled:opacity-60">{loading ? "جارٍ إنشاء الحساب..." : "إنشاء الحساب"}</button>
                </div>
              </StepFrame>}
            </div>
