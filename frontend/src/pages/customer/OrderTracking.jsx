    ...
    <main dir="rtl" className="min-h-screen bg-paper-2 pb-32 text-ink">
      ...
      <div className="mx-auto max-w-3xl px-5 py-6 sm:px-8">
        ...
        <section className="mt-6 rounded-[2rem] border border-ink/10 bg-white p-5 shadow-sm sm:p-6">
          <div className="flex items-start gap-3"><div className="grid h-10 w-10 shrink-0 place-items-center rounded-xl bg-ink text-paper"><FileText size={18} /></div><div><h2 className="font-bold">تحتاج شيئًا آخر؟</h2><p className="mt-1 text-xs leading-5 text-ink-soft">يمكنك طلب مساعدة النادل أو إرسال طلب الفاتورة من هنا.</p></div></div>
