...
import { getActiveSessionsNormalized } from "../../api/sessions";
...
export default function TableSessions() {
  ...
  useEffect(() => {
    getActiveSessionsNormalized().then((data) => { setInitial(data || []); setSessions(data || []); }).catch(setError).finally(() => setLoading(false));
  }, [setSessions]);
