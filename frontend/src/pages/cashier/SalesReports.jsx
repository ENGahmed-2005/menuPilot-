...
import { Download, FileSpreadsheet, Receipt, TrendingUp, WalletCards } from "lucide-react";
...
export default function SalesReports() {
  ...
  const visibleInvoices = useMemo(() => period === "today" ? invoices.filter((item) => item.date === "2026-09-09") : invoices, [period]);
