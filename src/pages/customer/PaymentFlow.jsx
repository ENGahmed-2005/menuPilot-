...
import { ArrowRight, ArrowLeft, Banknote, Check, CreditCard, FileImage, Loader2, Upload, WalletCards } from "lucide-react";
...
export default function PaymentFlow() {
  ...
  function goBack() { setError(""); if (step === 1) navigate(cartPath); else setStep((value) => value - 1); }
