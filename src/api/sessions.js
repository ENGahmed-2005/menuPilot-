...
function getLocation() {
  if (!window.isSecureContext && window.location.hostname !== "localhost" && window.location.hostname !== "127.0.0.1") throw locationError("تحديد الموقع يحتاج إلى HTTPS عند فتح الموقع من هاتف أو جهاز آخر. افتح نسخة HTTPS من النظام ثم حاول مرة أخرى.", "LOCATION_SECURE_CONTEXT_REQUIRED");
  if (!navigator.geolocation) throw locationError("هذا المتصفح لا يدعم تحديد الموقع.");
  return new Promise((resolve, reject) => navigator.geolocation.getCurrentPosition(resolve, (error) => {
    const messages = { 1: "تم رفض صلاحية الموقع. اسمح للموقع بالوصول إلى موقعك ثم أعد المحاولة.", 2: "تعذر تحديد موقعك حاليًا. تأكد من تشغيل خدمات الموقع وحاول مرة أخرى.", 3: "استغرق تحديد الموقع وقتًا طويلًا. تأكد من تشغيل GPS وحاول مرة أخرى." };
