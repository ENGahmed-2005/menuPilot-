...
Route::middleware('auth:sanctum')->group(function(){
 ...
 Route::apiResource('tables',TableController::class)->except(['show','create','edit']);
 ...
 Route::get('/sessions/{sessionId}/bill',[BillingController::class,'show']);
 Route::post('/sessions/{sessionId}/payment',[BillingController::class,'payment']);
 Route::patch('/sessions/{sessionId}/bill-items/{billItemId}',[BillingController::class,'adjust']);
 Route::patch('/me/plan',[SubscriptionController::class,'changePlan']);
 Route::post('/order-items/{id}/cancel',[OrderItemController::class,'cancel']);
 Route::post('/order-items/{id}/reassign',[OrderItemController::class,'reassign']);
});
