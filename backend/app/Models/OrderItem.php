...
class OrderItem extends Model
{
    ...
    public function reassignedSession() { return $this->belongsTo(DiningSession::class, 'reassigned_to_session_id'); }
    public function billAdjustments() { return $this->hasMany(BillAdjustment::class); }
}
