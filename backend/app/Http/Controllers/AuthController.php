...
class AuthController extends Controller
{
    ...
    public function register(Request $r)
    {
        ...
        $token = Str::random(60);
        $u = User::create(['name'=>$v['restaurant_name'],'restaurant_name'=>$v['restaurant_name'],'email'=>$v['email'],'password'=>Hash::make($v['password']),'plan'=>$v['plan']??'starter','role'=>'owner','api_token'=>hash('sha256',$token)]);
