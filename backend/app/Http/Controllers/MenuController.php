...
class MenuController extends Controller
{
    ...
    private function q($r){return DB::table('menu_items')->where('user_id',$r->user()->id);}
    ...
    public function publicMenu($code)
    {
        ...
        return $this->out([
            ...
            'items'=>DB::table('menu_items')->where('user_id',$t->user_id)->where('is_available',true)->orderBy('category')->orderBy('name')->get()
        ]);
    }
}
