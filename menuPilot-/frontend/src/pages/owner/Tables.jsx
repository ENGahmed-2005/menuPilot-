...
import { LayoutGrid, Plus, QrCode, Trash2, Users, Pencil, X, Check } from "lucide-react";
...
export default function Tables() {
  ...
  return (
    <div>
      <PageHeader title="الطاولات" subtitle="أضف طاولات مطعمك واحصل على رمز QR لكل واحدة." />

      <Card as="form" onSubmit={handleAdd} className="mb-6 flex flex-wrap items-end gap-3 p-4">
